                  ...
                  <tr className="hover" key={index}>
                    ...
                    <th>
                      <button
                        ...
                        className="btn btn-ghost btn-xs text-xl relative"
                      >
                        <CiMenuKebab />
                        {modal === index + 1 && (
                          <div className="absolute shadow-modal p-2 rounded-md right-10 -top-10 bg-slate-100 z-50 w-36 flex flex-col gap-2">
                            <button
                              onClick={() => {
